...
func TestAddQuestion(t *testing.T) {
	...
	f := new(models.Form{ID: "test-id", Title: "Test Form"})
...
func TestSaveFormNoQuestions(t *testing.T) {
	...
	f := new(models.Form{ID: "empty-id", Title: "Empty Form", Questions: []models.Question{}})
	s.CreateForm(t.Context(), f)
...
func TestListForms(t *testing.T) {
	...
	s.CreateForm(t.Context(), new(models.Form{ID: "f1", Title: "Form 1"}))
	s.CreateForm(t.Context(), new(models.Form{ID: "f2", Title: "Form 2"}))
...
func TestGetFormBySlug(t *testing.T) {
	...
	s.CreateForm(t.Context(), new(models.Form{ID: "f1", Title: "Form 1", ShareSlug: "myslug"}))
...
func TestSubmitResponse(t *testing.T) {
	...
	s.CreateForm(t.Context(), new(models.Form{ID: "f1", ShareSlug: "myslug"}))
